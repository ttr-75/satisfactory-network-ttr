...
function MyNetworkConnection:new(o)
    o = o or {}
    self.__index = self
    setmetatable(o, self)
    return o
...
function MyNetworkConnection:initNetBoot()
...
function MyNetworkConnection:loadFromNetBoot(name)
...
function MyNetworkConnection:loadCode(name)
    local content = nil
...
function MyNetworkConnection:parseModule(name)
...
function MyNetworkConnection:loadModule(name)
...
c = MyNetworkConnection.new()

c:loadModule("test2.lua");
